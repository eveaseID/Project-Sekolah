<div>
    <div class="row justify-content-center">
        <div class="text-header mb-5 text-primary">Edit Daftar Paket</div>
        <div class="col-md-6">
            <div class="shadow p-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#updateDaftarPaket">Pilih Paket</button>
                ...
                <div>
                    <button wire:click="updateDaftarPaket" class="btn btn-primary">Submit</button>

@if ($componentType == "ADD")
    @include('livewire.karyawan.createKaryawan')
@endif

@if ($componentType == "EDIT")
    @include('livewire.karyawan.editKaryawan')
@endif
        ...
        <div class="col-md-12">
            <div class="text-header mb-5">
                <h4 class="text-primary">
                    ...
                    <a href="{{ route('karyawan.print') }}" class="btn btn-outline-info float-end mx-2" target="_blank">EXPORT <i class='bx bx-download'></i></a>
                        ...
                        @forelse ($karyawan as $key => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button wire:click="deleteKaryawan({{ $item->id }})" class="btn btn-danger">

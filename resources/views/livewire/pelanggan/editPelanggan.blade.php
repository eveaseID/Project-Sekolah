<div>
    <div class="row justify-content-center">
        <div class="text-header mb-5 text-primary">Edit Pelanggan</div>
        <div class="col-md-6">
            <div class="shadow p-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="file" class="form-control @error('new_foto') is-invalid @enderror" wire:model="new_foto">
                    @error('new_foto')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div wire:loading wire:target="new_foto">
                        uploading...
                    </div>
                    ...
                    @else
                        <img src="{{ asset('uploads/pelanggan_images') }}/{{ $old_foto }}" class="mt-2" style="width: 100px; height: 100px; object-fit: cover">
                    @endif
                ...
                <div>
                    <button wire:click="updatePelanggan" class="btn btn-primary">Save</button>

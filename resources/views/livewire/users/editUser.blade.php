<div>
    <div class="row justify-content-center">
        <div class="text-header mb-5 text-primary">Edit User</div>
        <div class="col-md-6">
            <div class="shadow p-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="password" class="form-control @error('new_password') is-invalid @enderror" placeholder="password" wire:model="new_password">
                    @error('new_password')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div>
                    <button wire:click="updateUser" class="btn btn-primary">Save</button>

        ...
        <div class="col-md-6">
            <div class="shadow p-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="password" class="form-control @error('password_confirm') is-invalid @enderror" wire:model="password_confirm">
                ...
                <button wire:click="registerUser" class="btn btn-primary">Register</button>
            </div>
        </div>
    </div>
</div> --}}
...
<div class="container-register">
    <div class="content">
        ...
        <div class="left">
            <img src="icons/laravel.svg" alt="img" class="icon">
        </div>
        
        <div class="right">
            <div class="input">
                <div class="input-head">
                    <h4 class="text-header">Register</h4>
                    <input type="text" class="input-email @error('email') is-invalid @enderror" placeholder="Email" wire:model="email">
                    @error('email')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="input-head">
                    <div class="input-group">
                        <input type="text" id="input-nama-lengkap" class="input-password @error('nama_lengkap') is-invalid @enderror" placeholder="Nama" wire:model="nama_lengkap">
                        <button class="btn-pw" type="button" id="button-addon1">
                        </button>
                        <span class="input-border"></span>
                    </div>
                    @error('nama_lengkap')
                ...
                <div class="input-head">
                    <div class="input-group">
                        <input type="text" id="input-alamat" class="input-password @error('alamat') is-invalid @enderror" placeholder="Alamat" wire:model="alamat">
                        <button class="btn-pw" type="button" id="button-addon1">
                        </button>
                        <span class="input-border"></span>
                    </div>
                ...
                <div class="input-head">
                    <div class="input-group">
                        <input type="text" id="input-no_hp" class="input-password @error('no_hp') is-invalid @enderror" placeholder="Nomor HP" wire:model="no_hp">
                        <button class="btn-pw" type="button" id="button-addon1">
                        </button>
                        <span class="input-border"></span>
                    </div>
                ...
                <div class="input-head">
                    <div class="input-group">
                        <input type="password" id="input-password-register1" class="input-password @error('password') is-invalid @enderror" placeholder="Password" wire:model="password">
                        <button class="btn-pw" type="button" id="button-addon1" onclick="showPw1()">
                            <i class="bi bi-eye-slash-fill" id="eye-register1" style="color: grey; font-size: 20px"></i>
                        </button>
                        <span class="input-border"></span>
                    </div>
                    @error('password')
                ...
                <div class="input-head">
                    <div class="input-group">
                        <input type="password" id="input-password-register2" class="input-password @error('password_confirm') is-invalid @enderror" placeholder="Password Confirmation" wire:model="password_confirm">
                        <button class="btn-pw" type="button" id="button-addon1" onclick="showPw2()">
                            <i class="bi bi-eye-slash-fill" id="eye-register2" style="color: grey; font-size: 20px"></i>
                        </button>
                        <span class="input-border"></span>
                    </div>
                    @error('password_confirm')
                ...
                <div class="btn-bot">
                    <a href="{{ route('login') }}" class="btn-login">Already have account? Login</a>
                    <button class="btn-register" wire:click="registerUser">
                        Register
                        <div class="icon-1">
...
@section('scripts')
<script>
    var inputPw1 = document.getElementById("input-password-register1");
    var inputPw2 = document.getElementById("input-password-register2");
    var iconPw1 = document.getElementById("eye-register1");
    var iconPw2 = document.getElementById("eye-register2");

    function showPw1() {
        if (inputPw1.type === "password") {
            inputPw1.type = "text";
            iconPw1.classList.add("bi-eye-fill")
            iconPw1.classList.remove("bi-eye-slash-fill")
        } else {
            inputPw1.type = "password";
            iconPw1.classList.add("bi-eye-slash-fill")
            iconPw1.classList.remove("bi-eye-fill")
        }
    }

    function showPw2() {
        if (inputPw2.type === "password") {
            inputPw2.type = "text";            
            iconPw2.classList.add("bi-eye-fill")
            iconPw2.classList.remove("bi-eye-slash-fill")
        } else {
            inputPw2.type = "password";
            iconPw2.classList.add("bi-eye-slash-fill")
            iconPw2.classList.remove("bi-eye-fill")
        }
    }
